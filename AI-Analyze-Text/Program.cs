...
namespace text_analysis
{
    class Program
    {
        ...
        {
            // Lesson: https://microsoftlearning.github.io/AI-102-AIEngineer/Instructions/05-analyze-text.html
            try
            {
                ...
                foreach (var file in folder.GetFiles("*.txt"))
                {
                    ...
                    // Note: In this example, each review is analyzed individually,
                    // resulting in a separate call to the service for each file.
                    // An alternative approach is to create a collection of documents
                    // and pass them to the service in a single call
